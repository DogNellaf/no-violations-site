					...
					@foreach ($violations as $violation)
						<div class="row mt-3 violation"> 
							...
							@if (Auth::user()->is_admin)
								<div class="col-3">
									<a class="btn btn-info text-light mt-0 mb-0" href="{{ route('violation.edit', ['violation' => $violation]) }}">Редактировать</a>
								</div>
							@else
								<div class="col-3">
									<a class="btn btn-info text-light mt-0 mb-0" href="{{ route('violation.detail', ['violation' => $violation]) }}">Подробнее</a>
								</div>						
							@endif
						</div>
					@endforeach
